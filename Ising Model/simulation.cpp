...
simulation::simulation(int new_size, double new_temp, double new_J,
                       double new_H)
    : time(0), spins(lattice(new_size, new_J, new_H)), temperature(new_temp),
      mean_energy(new_J * (-4)), total_magnetisation(new_size * new_size),
